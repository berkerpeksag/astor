...
.. function:: json_to_ast(data)

   Given an AST in JSON form convert into into an AST node.

   The format of the JSON data supported by this function is
   the one generated by the `astexport` package.

   See https://github.com/fpoli/python-astexport for more details.
...
.. class:: file_util.JsonToAst

    This is the base class for the helper function :func:`json_to_ast`.
    It may be subclassed, but probably will not need to be.
